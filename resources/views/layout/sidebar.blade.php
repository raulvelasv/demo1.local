        ...
        <ul class="nav">
            ...
            <li class="nav-item {{ active_class(['apps/ficheros']) }}">
                <a href="{{ url('/apps/ficheros') }}" class="nav-link">
                    <i class="link-icon" data-feather="calendar"></i>
                    <span class="link-title">Subir archivos al Mayan</span>
                </a>
            </li>
            <li class="nav-item {{ active_class(['apps/ficherosOneDrive']) }}">
                <a href="{{ url('/apps/ficherosOneDrive') }}" class="nav-link">
                    <i class="link-icon" data-feather="calendar"></i>
                    <span class="link-title">Subir archivos a One Drive</span>
                </a>
            </li>
